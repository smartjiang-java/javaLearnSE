...
public class SwaggerConfig {
    ...
    public Docket createUserRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.jqk.controller"))
                // 扫描所有有注解的api
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                // 作者信息
                .contact(new Contact("JiangQikun", "https://www.cnblogs.com/ysocean/", "`1677081700@qq.com"))
                // 版本
                .version("版本号:" + "1.0")
                .build();
    }
